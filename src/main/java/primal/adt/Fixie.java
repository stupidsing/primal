...
import primal.adt.Fixie_.Fixie0;
import primal.adt.Fixie_.Fixie1;
import primal.adt.Fixie_.Fixie2;
import primal.adt.Fixie_.Fixie3;
import primal.adt.Fixie_.Fixie4;
import primal.adt.Fixie_.Fixie5;
import primal.adt.Fixie_.Fixie6;
import primal.adt.Fixie_.Fixie7;
import primal.adt.Fixie_.Fixie8;
import primal.adt.Fixie_.Fixie9;
...
public class Fixie<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> implements FixieA<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> {
	...
	Comparator<Fixie<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> comparator() {
		return (fixie0, fixie1) -> {
			var c = 0;
			c = c == 0 ? Compare.objects(fixie0.t0, fixie1.t0) : c;
			c = c == 0 ? Compare.objects(fixie0.t1, fixie1.t1) : c;
			c = c == 0 ? Compare.objects(fixie0.t2, fixie1.t2) : c;
			c = c == 0 ? Compare.objects(fixie0.t3, fixie1.t3) : c;
			c = c == 0 ? Compare.objects(fixie0.t4, fixie1.t4) : c;
			c = c == 0 ? Compare.objects(fixie0.t5, fixie1.t5) : c;
			c = c == 0 ? Compare.objects(fixie0.t6, fixie1.t6) : c;
			c = c == 0 ? Compare.objects(fixie0.t7, fixie1.t7) : c;
			c = c == 0 ? Compare.objects(fixie0.t8, fixie1.t8) : c;
			c = c == 0 ? Compare.objects(fixie0.t9, fixie1.t9) : c;
			return c;
		};
	}
	...
	public boolean equals(Object object) {
		if (Get.clazz(object) == Fixie.class) {
			var other = (Fixie<?, ?, ?, ?, ?, ?, ?, ?, ?, ?>) object;
			return true //
					&& Equals.ab(t0, other.t0) //
					&& Equals.ab(t1, other.t1) //
					&& Equals.ab(t2, other.t2) //
					&& Equals.ab(t3, other.t3) //
					&& Equals.ab(t4, other.t4) //
					&& Equals.ab(t5, other.t5) //
					&& Equals.ab(t6, other.t6) //
					&& Equals.ab(t7, other.t7) //
					&& Equals.ab(t8, other.t8) //
					&& Equals.ab(t9, other.t9) //
			;
		} else
			return false;
	}
