...
public class FltObjPuller<V> implements PullerDefaults<FltObjPair<V>, FltObjPair<V>, FltObjPredicate<V>, FltObjSink<V>, FltObjSource<V>> {
	...
	public void sink(FltObjSink<V> sink0) {
