...
public class FltIntPair {
	...
	private static FltIntPair none_ = FltIntPair.of(FltPrim.EMPTYVALUE, IntPrim.EMPTYVALUE);
	...
	public static Iterate<FltIntPair> mapFst(MapFst fun) {
		return pair -> of(fun.apply(pair.t0), pair.t1);
	}

	public static Iterate<FltIntPair> mapSnd(MapSnd fun) {
	...
	public boolean equals(Object object) {
		if (Get.clazz(object) == FltIntPair.class) {
